<template>
  ...
  >
    ...
    <div
      class="relative h-96 mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:items-center lg:px-8"
    >
        ...
        <li v-for="product in Products" :key="product._id">
          <a href="#" class="group relative block overflow-hidden">
            ...
            <div class="relative border border-gray-100 bg-white p-6">
              <span
                class="whitespace-nowrap bg-emerald-400 px-3 py-1.5 text-xs font-medium text-gray-700"
              >
                New
              </span>
  ...
  created() {
    ...
    axios
      ...
      .then((res) => {
        ...
        this.Products = res.data.filter(product => product.isFeatured === true);
