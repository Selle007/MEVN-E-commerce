    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <div class="mx-auto max-w-3xl">
        ...
        <div >
          <div class="mt-8">
            <ul class="space-y-4">
              <li class="flex items-center gap-4" v-for="items in cartItems" :key="item._id">
...
// Define the user ID (replace with your actual user ID)
...
export default {
  ...
  created() {
    // Make a GET request to retrieve the cart items for the user
